 ...
 import { Palette, Sun, Moon, Droplets, Sparkles, Zap } from 'lucide-react';
   ...
   return (
     <div className="space-y-4">
           ...
           {COLOR_GRADES.map((grade) => {
             ...
             return (
               ...
               >
                 ...
                 <p className={cn('text-xs font-medium', active && 'text-primary')}>{grade.name}</p>
       ...
       {selectedGrade && (
         <div className="panel">
           <div className="panel-header">
             <span className="panel-title">Grade Settings</span>
           </div>
             ...
             {[
               ...
               <div key={setting.label} className="space-y-1">
                 <div className="flex justify-between text-[10px]">
                   ...
                   <span className="text-foreground font-mono">{setting.value}</span>
                 </div>
                 <Slider
                   value={[setting.value]}
                   min={setting.range[0]}
